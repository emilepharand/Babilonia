...
import {initDb, clearDatabaseAndCreateSchema, stats as sc, ideaManager, practiceManager, languageManager, inputValidator, settingsManager, searchHandler} from './model/dataServiceProvider';
